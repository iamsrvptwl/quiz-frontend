    ...
    <div style={{ position: "relative" }}>
      ...
      {showLeaveModal && (
        ...
        >
          ...
          >
            ...
            >
              You have an ongoing test. Would you like to save your current
              progress to resume later, or discard this session entirely?
            </p>
            ...
            >
              ...
              >
                🗑️ Discard Test Record & Exit
              </button>

              {/* Option 3: Resume / Stay */}
              <button
      ...
      >
        ...
        <div style={{ ...styles.card, flex: "1 1 500px", margin: 0 }}>
          ...
          {/* ─── NEW BOTTOM RIGHT LEAVE TEST BAR ─── */}
          <div
            style={{
              display: "flex",
              justifyContent: "flex-end",
          ...
          >
            <button
              ...
              style={{
                ...styles.button,
                backgroundColor: "#DC2626", // Solid danger red background
